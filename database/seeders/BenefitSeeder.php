    ...
    public function run(): void
    {
          $data = [
            [
                ...
                'first_para'=>"Welcome to the heart of Europe, where the awe-
                        inspiring Alps meet idyllic cities, and where life's
                        Quality is as breathtaking as the landscape.",
                'image'=>'image/sofa.png',
                'priority'=>1,
                'rest_para'=>"In Switzerland, the standard of living is much more than a statistic. It's a tangible reality that you can see, touch, and experience in every facet of daily life. From world-renowned education and healthcare systems to robust public transport and innovative infrastructure, Switzerland excels in providing a quality of life that's second to none. <br class='b-br'>

                But there's so much more that makes Switzerland unique. It's where cutting-edge innovation blends seamlessly with centuries-old traditions. Where bustling, cosmopolitan cities lie just a short drive away from serene, picturesque villages. Where you can savor world-class chocolates and cheeses one moment, and take in the grandeur of pristine, snow-capped mountains the next.<br class='b-br'>
            ...
            [
                'title'=>'Geography',
                'first_para'=>"Centrally located amidst the iconic beauty
                        of Europe Switzerland stands as a testament to
                        nature's splendor and human innovation.",
                'image'=>'image/geography.png',
                'priority'=>2,
                'rest_para'=>"Tucked away in the Alpine region, Switzerland shares its borders with five countries - Germany to the north, France to the west, Italy to the south, and Austria and Liechtenstein to the east. This unique positioning makes it a cultural melting pot, boasting of rich linguistic diversity and a harmonious blend of traditions.<br class='b-br'>

                Encompassing a land area of 41,290 square kilometers, Switzerland is a tapestry of majestic mountain peaks, serene lakes, and vibrant cities. It's the home of the famous Swiss Alps, which cover about 60% of the country’s total land area, making it a paradise for mountaineering and winter sports enthusiasts. Meanwhile, the Swiss Plateau runs across the country, hosting most of the population and economic activity, including the dynamic urban centers of Zurich, Bern, and Geneva.<br class='b-br'>

                At the southernmost tip, you'll find the Mediterranean-influenced Canton of Ticino, offering a delightful mix of Italian flair, palm-lined lakes, and Alpine landscapes. And let’s not forget the stunning Rhine River flowing in the north, adding to Switzerland's charm and allure.<br class='b-br'>

                Despite its landlocked nature, Switzerland is anything but isolated. Its well-established transport networks - featuring some of the world's most scenic train routes - ensure seamless connectivity to the rest of Europe, making it an ideal base for exploring the continent.<br class='b-br'>
            ...
            [
                'title'=>'Climate',
                'first_para'=>"Switzerland, famed for its Alpine splendor, is a
                        land where the wether paints a dynamic
            ...
            [
                'title'=>'Ecology',
                'first_para'=>"In the heart of Europe lies Switzerland, a country
                        renowned not just for its picturesque landscapes
            ...
            [
                'title'=>'Safety',
                'first_para'=>"Experience the tranquiltity and security that is a
                        country globally recognized for its high safety
                        standsards and exceptional quality of life.",
                'image'=>'image/safety.png',
                'priority'=>6,
                'rest_para'=>"
                Safety in Switzerland is not an afterthought but an integral part of its ethos. This commitment reflects in its low crime rates, stringent law enforcement, and the overall sense of security that pervades both urban areas and countryside.<br class='b-br'>

                From bustling cities like Zurich and Geneva to the quiet, picturesque towns nestled in the Alps, residents and visitors alike can enjoy peace of mind. Switzerland's commitment to public safety ensures that whether you're navigating the lively city streets or exploring serene mountain trails, you're in a safe environment.<br class='b-br'>

                Switzerland's strong emphasis on social cohesion and respect for the rule of law also contributes to its reputation as a safe country. Here, individual rights are cherished, and mutual respect is deeply ingrained in the social fabric, creating a peaceful and harmonious society.<br class='b-br'>
            ...
            [
                'title'=>'Healthcare',
                'first_para'=>"Switzerland stands as a beacon of world-class
                            healthcare. Switzerland's healthcare system
                            consistently ranks among the best in the world.",
                    'image'=>'image/Medicine.png',
                    'priority'=>7,
                    'rest_para'=>"The foundation of Switzerland's healthcare success lies in its dedication to universal health coverage. Mandated health insurance ensures that everyone - Swiss nationals and expatriates alike - have access to comprehensive medical services. From routine check-ups and preventative care to specialized treatments and emergency services, healthcare in Switzerland is all-encompassing and patient-centered.<br class='b-br'>

                    The quality of care provided is exceptional, boasting a high doctor-to-patient ratio, advanced medical technology, and a strong focus on research and development. Switzerland is home to some of the world's best hospitals and research institutions, making it a leader in medical innovation and treatments.<br class='b-br'>

                    An integral part of Switzerland's healthcare system is its emphasis on prevention and public health. Regular health screenings, public health initiatives, and a robust network of pharmacies ensure that preventive care is easily accessible to all residents.<br class='b-br'>
            ...
            [
                'title'=>'Education',
                'first_para'=>"Welcome to the landscape of Swiss education, a
                                place where innovative learning, and holistic
                                development converge to extend future leaders.",
                        'image'=>'image/education.png',
                        'priority'=>8,
                        'rest_para'=>"Education in Switzerland is a testament to the country’s commitment to nurturing intellect and character. At its core is the promise of quality, equity, and accessibility, offering a robust learning experience to every student.<br class='b-br'>

                        From early childhood education to primary and secondary schooling, and all the way to university studies and vocational training, the Swiss education system offers a diverse range of pathways, catering to different interests and talents. This flexibility allows every student to find their niche and excel.<br class='b-br'>

                        With one of the world’s highest rates of education spending per student, Switzerland is a breeding ground for academic achievement and innovation. It is home to globally renowned universities and research institutions, making significant contributions to science, technology, humanities, and arts.<br class='b-br'>

                        Language learning forms an integral part of the Swiss curriculum, reflecting the country's multicultural fabric. Students typically learn two or more national languages, along with English, fostering multicultural understanding and opening international opportunities.<br class='b-br'>
            ...
            [
                ...
                'first_para'=>"Discover Switzerland's unique political landscape,
                        ...
                        Switzerland's commitment to direct democracy is another distinguishing feature. Citizens regularly participate in referendums to voice their opinion on a wide array of issues, from local matters to foreign policy. This involvement allows the Swiss people to play an active role in shaping their nation's laws and policies.<br class='b-br'>
