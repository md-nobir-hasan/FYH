...
@section('content')
    ...
    <!-- hero section -->
        <div class="mt-16 grid grid-cols-2">
            <div class="">
             ...
             <h3 class="text-6xl font-black"> @if($home !== null) {{ $home->title_one}} @endif </h3>
            <p class="text-md capitalize my-2 font-semibold font-sans" > @if($home !== null) {{ $home->title_one_description}} @endif </p>
            <h3 class="text-5xl font-black mt-5">@if($home !== null) {{ $home->title_two}} @endif</h3>
    ...
    <a href="{{route('about')}}" class="mt-8">
        ...
        <div class="mt-40">
            <div>
                <h1 class="text-5xl font-black text-center text-[#212427]"> @if($home !==null) {{$home->benefit_title}} @endif </h1>
                <p class=" text-center text-2xl font-normal"> @if($home !==null) {{$home->benefit_subtitle}} @endif</p>
            </div>
            ...
            <img src="{{'/storage/'.$item->image}}" alt="{{$item->title}}" class="h-16 w-16 mx-auto rounded-full" style="box-shadow: 0px 2px 5px 2px rgba(0, 0, 0, 0.08);">
        ...
        <section class="mt-[164px]">
            ...
            <div class="mt-3 grid grid-cols-1 lg:grid-cols-5">
                ...
                <div class="col-span-3">
                    <div>
                        <p class="mr-5 text-justify">I was struggling to find a job that aligned with my skills and experience, and I was starting to feel hopeless. That's when I found FYH. From the first consultation, they provided personalized guidance and support, taking the time to understand my career goals and helping me to identify job opportunities that matched my skill set. With their help, I was able to craft a strong resume and cover letter that really showcased my strengths. I even received interview coaching, which helped me to feel more confident and prepared when meeting with potential employers. Thanks to FYH, I was able to land a job that I'm truly excited about and that offers great opportunities for growth. I can't thank them enough for their excellent service and support throughout my job search journey</p>
                        <div class="flex">
                ...
                <div class="col-span-2">
                    ...
                    <h1 class=" text-white text-4xl font-black">Master Of</h1>
                    <h1 class=" text-white ml-[-50px] text-4xl font-black">Hapiness In Here </h1>
                    </div>
                </div>
            </div>
        ...
        <!-- Featured story end -->
                ...
                <section class="mt-[164px]">
                    <div>
                        <h1 class="text-5xl font-bold text-center text-[#212427]">The Most Popular Story</h1>
                        <p class="text-center text-2xl">Here’s the successful stories of our customer</p>
                    </div>
...
<div class=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <!-- successfull story Candidate start -->
        <section class="mt-[140px]">
                ...
                <a href="/" class=" flex justify-center items-center"><button class="lg:w-48 mt-5 p-3 rounded-lg font-semibold  bg-[#D1052C] text-white">READ THE STORY</button></a>
        </section>

    <!-- successfull story Candidate end -->
    <!-- Get Service Start -->
    <section class="mt-[122px]">
        <h1 class="text-center text-5xl font-black text-[#212427]">How to Get Services</h1>
        <p class="text-center text-2xl">Our Application process is very easy to use and user friendly. Let’s start...</p>
        <div class="mt-10 grid grid-cols-7">
                <div>
                <img src="/images/service1.png" alt="" class=""/>
                <h1 class="font-semibold text-xl">Select Package</h1>
                <p class="w-56 text-justify">Lorem Ipsum is simply dummy text of the printi ting and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever </p>
                </div>
                <div class="mt-16">
                <hr class="h-px ml-[-10px] mr-[27px] bg-[#D9D9D9] border-0">
                </div>
                <div>
                <img src="/images/service2.png" alt="" class=""/>
                <h1 class="font-semibold text-xl">Select Package</h1>
                <p class="w-56 text-justify">Lorem Ipsum is simply dummy text of the printi ting and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever </p>
                </div>
                <div class="mt-16">
                ...
                <div>
                <img src="/images/service3.png" alt="" class=""/>
                <h1 class="font-semibold text-xl">Select Package</h1>
                <p class="w-56 text-justify">Lorem Ipsum is simply dummy text of the printi ting and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever </p>
                </div>
                <div class="mt-16">
                ...
                <div>
                <img src="/images/service4.png" alt="" class=""/>
                <h1 class="font-semibold text-xl">Select Package</h1>
                <p class="w-56 text-justify">Lorem Ipsum is simply dummy text of the printi ting and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever </p>
                </div>
        </div>
    ...
    <!-- Get Service end -->
        ...
        <div class="mt-[165px]">
            <h1 class="font-bold text-5xl text-[#212427] text-center"> What Our Member Say</h1>
            <p class="text-2xl text-center text-[#212427]"> @if($home !==null) {{$home->story_subtitle}} @endif</p>
        ...
        <section class="mt-28 mb-[-100px]">
                <h1 class="font-bold text-5xl text-[#212427] text-center">We Are Excited To here your Story</h1>
                <p class="text-xl text-center text-[#D1052C] uppercase">Our community runs on voices like yours. It keep us going, and keeps us grounded. <br>Tell us like it is. What's your story?</p>
                <a href="/" class=" flex justify-center items-center"><button class="lg:w-48 mt-3 p-3 rounded-lg font-semibold  bg-[#D1052C] text-white">Share Your Story</button></a>
        </section>
        <!-- last section end -->
    </div>
@endsection
