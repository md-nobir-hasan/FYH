    ...
    <body class="bg-[#F5F5F5]" style="font-family: 'Montserrat';">
        <div class=" h-[815px] bg-[#F5F5F5] mx-40 rounded-xl mt-[107px] grid grid-cols-2">
            ...
            <div class="col-span 1 mt-[90px] mr-[60px]">
                @foreach ($membership_types as $member)
                    <!-- card 1 -->
                    <div class="w-[472px] h-[280px] border-2 border-black rounded-lg mb-[32px]">
                        <div class="mt-[20px] ml-[14px]">
                            ...
                            <div class="flex justify-between mr-[16px]">
                                ...
                                <h1 class="font-bold text-[25px]">{{ $member->price - $member->dis }}
                            ...
                            <div>
                                {!! $member->des !!}
                                {{-- @if ($member->dis>0)
                                    <h1 class="font-bold text-[20px] line-through text-[#848484] mr-[16px]">{{ $member->price }}
                                        {{ $member->currency->name }}/{{ $member->payDuration->name }}
                                    </h1>
                                @endif --}}
                                {{-- <p class="w-[236px] ml-[30px]">It’s the starter package for new comer. You can pay monthly and
                                    cancel anytime...</p>
                ...
                @endforeach
                <button
                    class="text-center w-[472px] h-[48px] bg-[#D1052C] rounded-[10px] text-white text-[16px] font-bold"><a
                        href="{{ route('register') }}">GET STARTED</a></button>
            </div>
        </div>
    </body>
@endsection
