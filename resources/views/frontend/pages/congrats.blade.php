...
<body>
    <div style="font-family: 'Poppins';background:url('/images/congratsbg.png');background-size:100%;background-position:top center;background-repeat:no-repeat">
        ...
        <h1 class="text-center text-[20px] font-normal mt-[20px] leading-normal">As a new member of FYH, you are not part of a community of like-minded people whose <br> goal is to relocate to Switzerland or who have already achieved it.</h1>
        <div class=" mt-5">
            <!-- <p class=" font-normal text-xl mb-3 max-w-[850px] mx-auto text-center"> @if($Congrat){{$Congrat->subtitle}} </span> @endif</p> -->
