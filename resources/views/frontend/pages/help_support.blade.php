...
<div class="mt-[100px]">
    <h1 class="text-5xl font-black text-center"> @if($tittles !==null)  {{$tittles->help_title}} {{auth()->user()->fname}} @endif</h1>
    ...
    <div class="mt-10 mb-[-100px]">
            ...
            <div class="lg:mx-28 grid grid-cols-3 gap-6 mt-10">

         @if($helps->count() > 0)
         @foreach ($helps as $help)
             
      
       <div class="block w-full px-6 py-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
