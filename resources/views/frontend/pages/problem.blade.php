...
<section class="md:mt-[67px] mt-[30px] 2xl:w-[1320px] mx-auto bg-white mb-[-150px]" style="font-family:'Poppins'">

    <div class="border 2xl:mx-0 md:mx-10 mx-5 md:px-20 px-5 py-14">
        <div class="">
            <a href="/ticket" class=""><button class=" flex items-center px-5 py-3 text-[#848484] text-[16px] font-bold hover:bg-[#F6CDD5] hover:text-[#D1052C] shadow-lg"><span class="mr-1"><svg class="text-[#848484] hover:text-[#D1052C]" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
