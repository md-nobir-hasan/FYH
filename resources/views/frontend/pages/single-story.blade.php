...
<section class="border-2 rounded grid grid-cols-1 lg:grid-cols-4 px-5 pt-5 w-[1320px] bg-white gap-[48px] mx-auto ">
    ...
    <div class="col-span-3 ">
        ...
        <svg  onclick=function1() id="svg" class="mt-[10px] ml-[10px]" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<p class="text-[#666565] capitalize font-normal text-base mb-[20px]">{{$story->city}}, @if($story->country !==null) {{$story->country->country}} @endif
</p>
...
<div  class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10 lg:mx-40"   >
    ...
    <div class=" bg-white border border-gray-200 rounded-lg shadow ">
        ...
        <div class="p-3 lg:h-1/2">
            <a href="#">
                <h5 class="mt-[20px] text-[20px] font-bold tracking-tight text-[#212427]">" {{Str::limit($story->title, 25)}} "</h5>
            </a>
...
<div  class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-10 w-[1320px] mx-auto"   >
    ...
    <div class="overflow-hidden bg-white border border-gray-200 rounded-lg shadow ">
        ...
        <div class="px-[22px] mt-[10px]">
            <a href="#">
                <h5 class="mt-[20px] text-xl font-bold tracking-tight text-[#212427]">"I have learnt so much, my memory got better, my morning routine got more structure"</h5>
            </a>
            ...
            <h1 class="text-[20px] font-semibold mt-[20px]">David Milan<h1>
                <p class="capitalize text-base font-normal">English Teacher</p>

                <p class="capitalize text-[16px] font-normal">Berlin,Germany</p>
    ...
    <div class="overflow-hidden bg-white border border-gray-200 rounded-lg shadow ">
        ...
        <div class="px-[22px] mt-[10px]">
            ...
            <h1 class="text-[20px] font-semibold mt-[20px]">David Milan<h1>
                <p class="capitalize text-[16px] font-normal">English Teacher</p>
    ...
    <div class="overflow-hidden bg-white border border-gray-200 rounded-lg shadow ">
        ...
        <div class="px-[22px] mt-[10px] h-[500px]">
            ...
            <p class=" text-[14px] font-normal text-[#212427] text-justify mt-5">I was struggling to find a job that aligned with my skills and experience, and I was starting Before this program I was struggling to remember things, such as PIN numbers, important dates, things to do at home, things to buy at store and I was having a hard time to concentrate and follow through with my learning.</p>
            <a href="" class="text-[#D1052C] font-bold text-[16px]">
                Read more
            </a>
            <h1 class="text-[20px] font-semibold mt-[20px]">David Milan<h1>
...
<section class=" mb-[-100px]"  style="background:url(/images/Line2.png);background-size:100% ;background-repeat:no-repeat;background-position:center">
            <div class="pb-10 pt-36 mt-[69px]"style="background:url(/images/lastbg.png);background-size:100% 100%;background-repeat:no-repeat;">
            <div class="pb-14 shadow-lg">
            <h1 class="font-bold text-[50px] text-[#212427] text-center">
            @if($share !==null)   {{$share->share_title}}    @endif
            </h1>

            <p class="text-[24px] text-center text-[#D1052C] capitalize mx-96">
            @if($share !==null) {!!$share->share_subtitle !!} @endif
            </p>
                <div class="flex justify-center items-center">
                <a href="{{route('share.story')}}" class=" "><button
