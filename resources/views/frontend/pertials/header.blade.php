...
--}}
  ...
  <path d="M7.9991 17.629C-0.000897884 10.429 -0.000897825 4.96235 0.999102 3.12902C5.79838 -2.47094 9.9994 1.46237 11.5 4.12902C13.5 1.96235 18.4 -1.27098 22 3.12902C25.6 7.52902 16.5 17.2957 11.5 21.629C11.5 21.2957 10.7998 20.029 7.9991 17.629Z" fill="#D1052C"/>
</svg>
                            ...
                            <div class="mt-[10px]  border" style="box-shadow: 0px 4px 5px 0px rgba(0, 0, 0, 0.08);">
                                <div class="py-[10px] pl-[20px] flex">
                                    ...
                                    <h1 class="text-[12px] mt-[7px] font-normal leading-normal ml-[10px]">I have learn so much, My Memory got better, my morning routine...</h1>
                                </div>
                            </div>
                            <div class="mt-[10px]  border" style="box-shadow: 0px 4px 5px 0px rgba(0, 0, 0, 0.08);">
                                <div class="py-[10px] pl-[20px] flex">
                    ...
                    <button type="button"
                            class="flex mr-3 text-sm  md:mr-0 "
                            id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdownn"
                            data-dropdown-placement="bottom">
                            <span class="sr-only">Open user menu</span>
  ...
  <mask id="mask0_2891_19529" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="30" height="31">
    <rect y="0.174805" width="30" height="30" fill="#D1052C"/>
  </mask>
  <g mask="url(#mask0_2891_19529)">
    <path d="M5 24.4248V21.9248H7.5V13.1748C7.5 11.4456 8.02083 9.90918 9.0625 8.56543C10.1042 7.22168 11.4583 6.34147 13.125 5.9248V3.1748H16.875V5.9248C18.5417 6.34147 19.8958 7.22168 20.9375 8.56543C21.9792 9.90918 22.5 11.4456 22.5 13.1748V21.9248H25V24.4248H5ZM15 28.1748C14.3125 28.1748 13.724 27.93 13.2344 27.4404C12.7448 26.9508 12.5 26.3623 12.5 25.6748H17.5C17.5 26.3623 17.2552 26.9508 16.7656 27.4404C16.276 27.93 15.6875 28.1748 15 28.1748ZM10 21.9248H20V13.1748C20 11.7998 19.5104 10.6227 18.5312 9.64355C17.5521 8.66439 16.375 8.1748 15 8.1748C13.625 8.1748 12.4479 8.66439 11.4688 9.64355C10.4896 10.6227 10 11.7998 10 13.1748V21.9248Z" fill="#D1052C"/>
    <path d="M21.5019 23.5466H8.50189C8.16855 20.5466 7.80189 13.9466 9.00189 11.5466C10.5019 8.5466 10.5019 8.04662 15.0019 7.04662C18.6019 6.24662 20.8352 9.71328 21.5019 11.5466V23.5466Z" fill="#D1052C"/>
  </g>
</svg>
</svg>
                            ...
                            <div class="mt-[10px]  border" style="box-shadow: 0px 4px 5px 0px rgba(0, 0, 0, 0.08);">
                                <div class="py-[10px] pl-[20px] flex">
                                <div class="flex justify-center items-center"><svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect y="0.783203" width="15" height="15" rx="7.5" fill="#212427"/>
</svg></div>

                                    <div>
                                    <h1 class="text-[12px] mt-[7px] font-bold leading-normal ml-[10px]">Here’s a unread notification about your ...</h1>
...
<rect y="0.783203" width="15" height="15" rx="7.5" fill="#212427"/>
                            ...
                            <div class="mt-[10px]  border" style="box-shadow: 0px 4px 5px 0px rgba(0, 0, 0, 0.08);">
                                <div class="py-[10px] pl-[20px] flex">
                                <div class="flex justify-center items-center"><svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect y="0.216797" width="15" height="15" rx="7.5" fill="#848484"/>
</svg>
</div>

                                    <div>
                                    <h1 class="text-[12px] mt-[7px] font-normal leading-normal ml-[10px]">Here’s a unread notification about your ...</h1>
                                    <h1 class="ml-[10px] text-[10px] text-[#848484]">Sun April 23,2023</h1>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="flex items-center ml-8 md:order-2">
                        ...
                        <div class="z-50 lg:w-80 hidden my-4 text-base list-none bg-white rounded-lg shadow"
                            ...
                            <div class="flex pt-[25px] pl-[25px]">
                                ...
                                <span
                                    class="flex justify-center items-center ml-2 text-[20px] font-semibold  capitalize">
  ...
  <path d="M8.33724 8.58854L7.53516 7.74271L9.02266 6.25521H4.25391V5.08854H9.02266L7.53516 3.60104L8.33724 2.75521L11.2539 5.67188L8.33724 8.58854ZM0.753906 10.9219V0.421875H6.00391V1.58854H1.92057V9.75521H6.00391V10.9219H0.753906Z" fill="#212427"/>
                            ...
                            <div class="flex justify-center mt-1 items-center">
                                <h1 class="text-[12px] text-[#212427] font-normal mb-[20px]"> <a href="{{ route('terms.condition') }}">Terms & Condition</a></h1>
                                <p class="ml-[20px] mb-[20px] text-[12px] text-[#212427] font-normal"> <a href="{{ route('cookies') }}">Cookie Policy</a> </p>
                            </div>
                        </div>
                    </div>
