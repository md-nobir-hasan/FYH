                             ...
                             <tbody>
                                @foreach ($integration as $key=>$item)
                                    <tr
                                        ...
                                        class="px-6 py-2 border-r font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        @if($item->status ==1)
                                        <a href="{{route('admin.integrations.status', $item->id)}}" class="bg-blue-800 px-4 py-2 rounded-lg text-white">Active</a>
                                        @else
                                        <a href="{{route('admin.integrations.status', $item->id)}}" class="bg-red-800 px-4 py-2 rounded-lg text-white">Dective</a>
                                        @endif
                                    </th>
                                        @if ($n->edit || $n->delete)
                                            <td class="px-6 py-2 text-center ">
                                                <div class="flex justify-center">
                                                    @if ($n->show)
                                                    <a href="{{route('admin.integrations.show',$item->id)}}" target="_blank"
                                                ...
                                                @endif
                                                @if ($n->edit)
                                                    <a href="{{route('admin.integrations.edit',$item->id)}}"
                                                ...
                                                @if ($n->delete)
                                                   {{-- <div class="delete"> --}}
                                                     <a href="{{route('admin.integrations.destroy',$item->id)}}"
