            ...
            <div class="block rounded-lg bg-white text-center shadow-lg dark:bg-neutral-700">
                <div class="border-b-2 border-neutral-100 py-3 px-6 dark:border-neutral-600 dark:text-neutral-50">
                    <div class="flex justify-between">
                        <h4 class="text-bold text-lg">Problem</h4>
                             ...
                             <tbody>
                                ...
                                {{Str::limit($item->answer, 30)}}
                                         ...
                                         <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        @if($item->status == 0)
                                            <span class="bg-red-600 p-2 mx-2 text-white rounded-md">Open</span>
                                        @else  <span class="bg-blue-600 p-2 mx-2 text-white rounded-md">Solved</span>
                                       @endif
                                    </th>
                                        <th scope="row"
                                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                   @if($item->created_at !==null) {{$item->created_at->format('d-m-Y')}} @endif
                                    </th>
                                        ...
                                        @if ($n->edit || $n->delete)
                                            <td class="px-6 py-4 text-center ">
                                                <div class="flex justify-center">
                                                    @if ($n->show)
                                                    <a href="{{route('admin.page.problem.show',$item->id)}}" target="_blank"
                                                ...
                                                @endif
                                                @if ($n->edit)
                                                    <a href="{{route('admin.page.problem.edit',$item->id)}}"
                                                ...
                                                @if ($n->delete)
                                                     ...
                                                     <a href="{{route('admin.page.problem.destroy',$item->id)}}"
