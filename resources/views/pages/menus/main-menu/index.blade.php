                    ...
                    <ul
                        ...
                        @foreach ($client_tyes as $ct_types )
                            <li role="presentation" class="flex-auto text-center">
                                ...
                                data-te-toggle="pill"
                                data-te-target="#tabcontent{{$ct_types->id}}"
                                role="tab"
                                    ...
                                    @foreach ($all_menus as $mdata)
                                        @foreach ($mdata as $value)
                                            <tr
                                                ...
                                                <th scope="row"
                                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    {{ $value->client_type ? $value->client_type->name : "Normal User" }}
                                                </th>
                                                <th scope="row"
                                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    {{ $value->link->url }}
                                ...
                                <tbody>
                                    @foreach ($ct_types->menu() as $menu)
                                        <tr
                                            ...
                                            <th scope="row"
                                                class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                {{ $menu->client_type ? $menu->client_type->name : "Normal User" }}
                                            </th>
                                            <th scope="row"
                                                class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                {{ $menu->link->url }}
                                    ...
                                    <tbody>
                                        @foreach ($normal_users_menus as $nums)
                                            <tr
                                                ...
                                                <th scope="row"
                                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    {{ $nums->client_type ? $nums->client_type->name : "Normal User" }}
                                                </th>
                                                <th scope="row"
                                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    {{ $nums->link->url }}
