                ...
                <div class="p-6">
                    <div class="overflow-x-auto shadow-md sm:rounded-lg">
                        <div class="flex justify-center items-center mb-3">
                            ...
                            @endif
                            @if ($n->edit)
                                <a href="{{ route('admin.menu.menu.edit', [$mdata->id]) }}" target="_blank"
                                    ...
                                    <div class="overflow-hidden">
                                        <table class="min-w-full text-center text-sm font-light">
                                            <tbody>
                                                ...
                                                <tr class="border-b border-success-200 bg-danger-100 text-neutral-800">
                                                    <th>Menu Url</th>
                                                    <th>:</th>
                                                    <td class="whitespace-nowrap px-6 py-4 font-medium">
                                                        {{ $mdata->link ?  $mdata->link->url : '' }}
                                                    </td>
                                                </tr>
                                                <tr class="border-b border-success-200 bg-success-100 text-neutral-800">
                                                    <th>Menu For</th>
                                                    <th>:</th>
                                                    <td class="whitespace-nowrap px-6 py-4 font-medium">
                                                        {{ $mdata->client_type ?  $mdata->client_type->name : '' }}
                                                    </td>
                                                </tr>
                                                <tr class="border-b border-success-200 bg-danger-100 text-neutral-800">
                                                    <th>Menu Serail</th>
