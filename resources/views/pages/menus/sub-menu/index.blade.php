            ...
            <div class="block rounded-lg bg-white text-center shadow-lg dark:bg-neutral-700">
                <div class="border-b-2 border-neutral-100 py-3 px-6 dark:border-neutral-600 dark:text-neutral-50">
                    <div class="flex justify-between">
                        <h4 class="text-bold text-lg">Sub-menu</h4>
                        @if ($n->add)
                            <a href="{{ route('admin.menu.submenu.create') }}">
                        ...
                        <table class=" text-md mx-auto min-w-[50%] text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @foreach ($mdata as $value)
                                        ...
                                        <tr
                                            ...
                                            @if ($n->edit || $n->delete)
                                                <td class="px-6 py-4 text-center flex">
                                                    @if ($n->edit)
                                                        <a href="{{route('admin.menu.submenu.edit',[$value->id])}}"
                                                    ...
                                                    @if ($n->delete)
                                                    {{-- <div class="delete"> --}}
                                                        <a href="{{route('admin.delete',[$value->id,'Submenu'])}}"
                                    ...
                                    @if ($loop->first)
                                        <tr>
                                            <td colspan="5" class="text-center my-10">There are no sumbenus</td>
                                        </tr>
                                    @endif
                                    @endif
