                                        ...
                                        @if ($n->edit || $n->delete)
                                            <td class="px-6 py-4 text-center ">
                                                <div class="flex justify-center">
                                                    @if ($n->show)
                                                    <a href="{{route('admin.page.helps.show',$item->id)}}" target="_blank"
                                                ...
                                                @endif
                                                @if ($n->edit)
                                                    <a href="{{route('admin.page.helps.edit',$item->id)}}"
                                                ...
                                                @if ($n->delete)
                                                   {{-- <div class="delete"> --}}
                                                     <a href="{{route('admin.page.helps.destroy',$item->id)}}"
