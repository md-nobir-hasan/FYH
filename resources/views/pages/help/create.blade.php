        ...
        <div class="block rounded-lg bg-white text-center shadow-lg dark:bg-neutral-700">
            ...
            <div class="p-6 mx-auto bg-gray-100">
                <div class="block mx-auto min-w-full rounded-lg bg-white p-6  shadow-lg dark:bg-neutral-700">
                    <h1 class="text-center font-bold text-2xl bg-white rounded mb-2">Service Add</h1>
                    <form action="{{route('admin.page.services.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <h4 class="font-bold text-xl underline text-left">Service Section</h4>
