            ...
            <div class="block rounded-lg bg-white text-center shadow-lg dark:bg-neutral-700">
                <div class="border-b-2 border-neutral-100 py-3 px-6 dark:border-neutral-600 dark:text-neutral-50">
                    <div class="flex justify-between">
                        <h4 class="text-bold text-lg">Content</h4>
                        @if ($n->add)
                                        ...
                                        @if ($n->edit || $n->delete)
                                            <td class="px-6 py-4 text-center ">
                                                <div class="flex justify-center">
                                                    @if ($n->show)
                                                    <a href="{{route('admin.contents.show',$item->id)}}" target="_blank"
                                                ...
                                                @if ($n->delete)
                                                   {{-- <div class="delete"> --}}
                                                     <a href="{{route('admin.contents.destroy',$item->id)}}"
