            ...
            <div class="block rounded-lg bg-white text-center shadow-lg dark:bg-neutral-700">
                <div class="border-b-2 border-neutral-100 py-3 px-6 dark:border-neutral-600 dark:text-neutral-50">
                    <div class="flex justify-between">
                        <h4 class="text-bold text-lg">Memberships</h4>
                        @if ($n->add)
                            <a href="{{ route('admin.setup.membership.create') }}">
                                    ...
                                    <tr
                                        ...
                                        @if ($n->edit || $n->delete)
                                            <td class="px-6 py-4 text-center flex">
                                                @if ($n->show)
                                                    <a href="{{route('admin.setup.membership.show',[$value->id])}}" target="_blank"
                                                ...
                                                @endif
                                                @if ($n->edit)
                                                    <a href="{{route('admin.setup.membership.edit',[$value->id])}}"
                                                ...
                                                @if ($n->delete)
                                                   {{-- <div class="delete"> --}}
                                                    <a href="{{route('admin.delete',[$value->id,'MembershipType'])}}"
