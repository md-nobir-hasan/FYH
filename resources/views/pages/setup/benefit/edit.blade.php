        ...
        <div class="block rounded-lg bg-white text-center shadow-lg dark:bg-neutral-700">
            <div class="border-b-2 border-neutral-100 py-3 px-6 dark:border-neutral-600 dark:text-neutral-50">
                <div class="flex justify-between">
                    <h4 class="text-bold text-lg">Updating Benefit</h4>
            ...
            <div class="p-6 mx-auto bg-gray-100">
                ...
                <div class="block mx-auto max-w-md rounded-lg bg-white p-6  shadow-lg dark:bg-neutral-700">
                    <form action="{{ route('admin.setup.benefit.update', [$mdata->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="">
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                <div class="text-left">
                                    ...
                                    >Title: </label
                                  >
                                  <input name="title" value="{{$mdata->title}}"
                                ...
                                <div class="text-left">
                                    ...
                                    >Priority: </label
                                  >
                                  <input name="priority" value="{{$mdata->priority}}"
                            ...
                            <div class="mt-10">
                             ...
                             <img src="{{'/storage/'.$mdata->image}}" width="60px" alt="">
                    </form>
                </div>
