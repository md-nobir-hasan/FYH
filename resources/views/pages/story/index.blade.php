            ...
            <div class="block rounded-lg bg-white text-center shadow-lg dark:bg-neutral-700">
                <div class="border-b-2 border-neutral-100 py-3 px-6 dark:border-neutral-600 dark:text-neutral-50">
                    <div class="flex justify-between">
                        <h4 class="text-bold text-lg">Story</h4>
                        @if ($n->add)
                             ...
                             <tbody>
                                ...
                                {{$item->profession}}
                                    ...
                                    {{$item->address}}
                                        ...
                                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        @if($item->status ==1)
                                        <a href="{{route('admin.stories.status', $item->id)}}" class="bg-blue-800 px-4 py-2 rounded-lg text-white">Active</a>
                                        @else
                                        ...
                                        @if ($n->edit || $n->delete)
                                            <td class="px-6 py-4 text-center ">
                                                <div class="flex justify-center">
                                                    @if ($n->show)
                                                    <a href="{{route('admin.stories.show',$item->id)}}" target="_blank"
                                                ...
                                                @endif
                                                @if ($n->edit)
                                                    <a href="{{route('admin.stories.edit',$item->id)}}"
                                                ...
                                                @if ($n->delete)
                                                     ...
                                                     <a href="{{route('admin.stories.destroy',$item->id)}}"
