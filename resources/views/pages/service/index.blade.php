                                        ...
                                        @if ($n->edit || $n->delete)
                                            <td class="px-6 py-4 text-center ">
                                                <div class="flex justify-center">
                                                    @if ($n->show)
                                                    <a href="{{route('admin.page.services.show',$item->id)}}" target="_blank"
                                                ...
                                                @endif
                                                @if ($n->edit)
                                                    <a href="{{route('admin.page.services.edit',$item->id)}}"
                                                ...
                                                @if ($n->delete)
                                                   {{-- <div class="delete"> --}}
                                                     <a href="{{route('admin.page.services.destroy',$item->id)}}"
