...
class AboutController extends Controller
{
    ...
    public function store(AboutRequest $request)
    {
        ...
        About::create([
            ...
            'fimg_title' => $request->fimg_title,
            'fimg_subtitle' => $request->fimg_subtitle,
            'fimg_story' => $request->fimg_story,
            'second_image' => $second_image,
            'simg_title' => $request->simg_title,
            'simg_subtitle' => $request->simg_subtitle,
            'simg_story' => $request->simg_story,
        ]);
